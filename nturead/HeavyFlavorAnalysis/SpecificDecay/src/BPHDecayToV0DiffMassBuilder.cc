...
BPHDecayToV0DiffMassBuilder::BPHDecayToV0DiffMassBuilder(
               ...
               const std::string& d1Name, double d1Mass, double d1Sigma,
               const std::string& d2Name, double d2Mass, double d2Sigma,
...
void BPHDecayToV0DiffMassBuilder::buildFromBPHGenericCollection() {
  ...
  BPHDecayToTkpTknSymChargeBuilder b( *evSetup,
                                      p1Name, p1Mass, p1Sigma,
                                      p2Name, p2Mass, p2Sigma,
                                      p1Collection, p2Collection, expMass );
