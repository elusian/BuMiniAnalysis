...
// additional features: second ntuple
  ...
  int GetClosestTrackGen( float eta, float phi );
  std::optional<std::array<int, 5>> getBuVertexComponents(int iBuGen);
  std::optional<std::array<int, 4>> getPsi2SVertexComponents(int iPsi2SGen);
  std::optional<std::array<int, 2>> getJPsiVertexComponents(int iJPsiGen);
