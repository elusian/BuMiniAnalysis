...
process.GlobalTag = GlobalTag(process.GlobalTag, "insert_GT_here", '')
...
#    labelTaus         = cms.string('slimmedTaus'),
    ...
    vertReco = cms.vstring('svtBuJPsiK','svtBdJPsiKx','svtBsJPsiPhi',"svtBuPsi2SK"),
